...
\sigma_r(T) &= \left\{\lambda \in \mathbb{C} \:\middle| \substack{\large\lambda I-T \text{ injective} \\[5pt]\large \lambda I -T \text{ NOT surjective} \\[5pt]\large \overline{\text{im }(\lambda I -T)} \neq X}  \:\right\} \tag{Residual Spectrum}
\end{align*} $$
So by definition
