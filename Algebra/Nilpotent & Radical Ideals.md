...
- By induction assume the claim for $e_i$. Therefore $e_{i+1}x=(3e_i^2-2e_i^3)x= (3-2)x$ and ![[Ring-1767874849382.png]]where the last line follows by induction since $e_i-e_i^2 \in N^{2i}$. This completes the proof of claim. $\square$
